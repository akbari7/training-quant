...
def cek_kondisi_pasar(symbol='BTC-USD'):
    print(f"Sedang menganalisis {symbol} ... Mohon tunggu ⏳")
    ...
    header = f"🤖 *LAPORAN {tanggal}: {symbol.upper()}*"
    ...
    print(f"✅ Laporan {symbol} terkirim ke HP!")

# Jalankan Scanner
cek_kondisi_pasar('BTC-USD')